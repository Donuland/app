...
if (typeof eventBus !== 'undefined') {
    ...
    eventBus.on('part4ALoaded', () => {
        console.log('📅 Part 4A loaded, setting up Part 4C integration');
...
if (typeof window !== 'undefined') {
    ...
    // Override původní showEventDetail z Part 4A
    window.showEventDetail = showEventDetailExtended;
...
console.log('✅ Donuland Part 4C (simplified) loaded successfully');
console.log('🎯 Practical features: Add/Edit/Delete events, Simple search, Basic statistics, CSV export');
console.log('➕ Quick Add: Fast event creation with validation');
console.log('✏️ Edit Mode: Click on event for detailed editing');
console.log('🔍 Simple Search: Live filtering by name, category, city, notes');
console.log('📊 Basic Stats: Overview with top categories, cities, and accuracy tracking');
console.log('🎛️ Action Panel: All main functions in simple toolbar');

// Emit completion event
if (typeof eventBus !== 'undefined') {
    eventBus.emit('part4CLoaded', { 
        timestamp: Date.now(),
        version: '4C-simplified-1.0.0',
        features: [
            'quick-add-modal',
            'event-editing-modal',
